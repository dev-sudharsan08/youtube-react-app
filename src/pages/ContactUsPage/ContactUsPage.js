...
export class ContactUsPage extends Component {
  ...
  handleSubmit = (event) => {
    ...
    event.preventDefault(); // stopping the pg refresh
    // read the form data
    ...
    // Lts's use axios -- so install it from npmjs.com -- npm i axios
    axios
  ...
  render() {
    return (
      <div className='container'>
        <HelmetSetup title='Contact Us Page' />
        <div className='row justify-content-center'>
          ...
          <div className='col-md-4'>
            <form onSubmit={this.handleSubmit}>
              ...
              <button type='submit' data-testid='submitBtn' className='btn btn-primary' disabled={this.state.fullName === ''}>
                Send
              </button>
              {this.state.isSaved
                ? (
